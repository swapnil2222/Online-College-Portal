	...
	<div class="content_item">
	   ...
	   <div id="content-bottom">
			...
			<li class="egg">
				...
				<?php
			$listsql=mysql_query("SELECT * FROM `message` WHERE toEmail='$email' ORDER BY msgId DESC ");
			...
			<div class="comment_ui">
				...
				<div class="bbbbbbb" id="view<?php echo $id; ?>">
					...
					<a href="test_inbox.php" class="view_comments" id="<?php echo $id; ?>">Back To Messages</a>
					</div>
				</div>
			</li>
